StratTourn: Developing New Games
========================================================================
...
This guide describes how new games can be developed for StratTourn.

## Basic structure

Our noisy prisoners' dilemma game is specified by the following function:
...
```{r eval=TRUE, cache=!TRUE}
  run.rep.game(delta=0.9, game=game, 
               strat = nlist(strange.defector,tit.for.tat),T.min=20)
```
